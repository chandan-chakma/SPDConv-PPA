...
if __name__ == "__main__":
    ...
    model = YOLO(r"runs\detect\train10\weights\best.pt").load("yolov8n.pt")  # build from YAML and transfer weights

    results = model.train(data=r"datasets\UAVDT1\data.yaml", epochs=10, imgsz=1024, batch=2)
